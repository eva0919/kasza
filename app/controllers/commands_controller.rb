class CommandsController < ApplicationController
  ...
  def command_post
    @command = Command.new(:picture_id=>params[:picture_id],:fb_id=>params[:fb_id],:fb_name=>params[:fb_name],:content=>params[:content]);
    @command.save
  ...
  def command_page
    @commands = Command.where(:picture_id=>params[:id])
