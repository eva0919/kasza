Picstory::Application.routes.draw do
  ...
  post '/command_post' => 'commands#command_post'
  ...
  post '/matchtag' => 'pictures#matchtag'
  post '/matchtag/:tag/:query' => 'pictures#matchtag'
  get '/matchtag' => 'pictures#matchtag'
  get '/matchtag/:tag/:query' => 'pictures#matchtag'
